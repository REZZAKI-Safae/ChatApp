...
public class MainActivity extends BaseActivity implements ConversionListener {
    ...
    private void init(){
        ...
        binding.conversationRecycleView.setAdapter(conversionAdapter);
            ...
            for (DocumentChange documentChange : value.getDocumentChanges()) {
                if (documentChange.getType() == DocumentChange.Type.ADDED){
                    ...
                    if (preferenceManager.getString(Constants.KEY_USER_ID).equals(senderId)){
                        ...
                        chatMessage.conversionLanguage = documentChange.getDocument().getString(Constants.KEY_RECEIVER_LANGUAGE);
                    } else {
                        ...
                        chatMessage.conversionLanguage = documentChange.getDocument().getString(Constants.KEY_SENDER_LANGUAGE);
                    }
                    ...
                    for (int i =0 ; i< conversations.size(); i++){
                        ...
                        if (conversations.get(i).senderId.equals(senderId) && conversations.get(i).receiverId.equals(receiverId)){
                            ...
                            conversations.get(i).conversionLanguage = documentChange.getDocument().getString(Constants.KEY_LANGUAGE);
